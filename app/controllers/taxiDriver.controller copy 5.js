        ...
        if (postbackData.includes("action=confirm")) {
          ...
          try {
            ...
            if (rows.length === 0) {
              ...
              //Todo ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
              let confirmField =
                direction === "go" ? "CONFIRM_go" : "CONFIRM_back";

              if (row[confirmField] === "standby") {
            ...
            if (rows.length === 0) {
              ...
              if (check_eject === "go") {
                if (rows[0].CONFIRM_go === "standby") {
                  ...
                  console.log("บันทึกข้อมูลซ้ำ ขาไป");
                }
              } else if (check_eject === "back") {
                if (rows[0].CONFIRM_back === "standby") {
                  await connection.execute(
                  ...
                  console.log("บันทึกข้อมูลซ้ำ ขากลับ");
                }
              }
